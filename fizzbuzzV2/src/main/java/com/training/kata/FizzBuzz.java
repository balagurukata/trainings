...
public class FizzBuzz {
	...
	public String divisible(int divisibleNumber) {
		String returnValue = Optional.of(divisibleNumber)
				.map(divNum -> (divNum % DIVISIBLE_NUMBER_3 == 0 ? STRING_FIZZ : "")
						+ (divNum % DIVISIBLE_NUMBER_5 == 0 ? STRING_BUZZ : ""))
				.get();
		return returnValue.isEmpty() ? Integer.toString(divisibleNumber) : returnValue;
	}
